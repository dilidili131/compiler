...
public class DFA {
    ...
    public ArrayList<Map<String, Object>> createDFA(
            ArrayList<Map<String, Object>> al,     //初始为空
            ArrayList<Map<String, Object>> parent) {//初始为空
        ...
        while (true) {
            ...
            pos++;
            Map<String, String> project = (Map<String, String>) m.get("project");
            ...
            for (Map<String, String> p : production) {
                ...
                if (pl.equals(nextCh)) {
                    ...
                    newproj.put("pos", production.indexOf(projectToProduction(newPro)));
        ...
        for (Map<String, Object> project : Union) {
            Map<String, String> pro = (Map<String, String>) project.get("project");
            ...
            if (!right.endsWith(".")) {
                ...
                for (Map<String, Object> map : next) {
                    if (map.get("edge").equals(edge)) {
                        newAl = (ArrayList<Map<String, Object>>) map.get("value");
                        break;
                    }
                }
